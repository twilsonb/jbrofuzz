...
/**
 * <p>A file filter implementation, leaving only .jbrofuzz files.
 * Case is ignored.</p>
 * 
 * <p>Originally inspired by the ExampleFileFilter class 
 * implemented by Jeff Dinkins (version 1.16, 26/07/04).</p>
 */
public class JBroFuzzFileFilter extends FileFilter {
	...
	public JBroFuzzFileFilter() {
		...
		this.filters = new Hashtable<String, JBroFuzzFileFilter>();
		// add the .jbrofuzz extension and its description
		this.addExtension("jbrofuzz");
		this.setDescription("JBroFuzz Fuzzing Session Files");
	}
	...
	/**
	 * <p>Returns "JBroFuzz Fuzzing Session Files".</p>
	 * 
	 * 
	 ...
	 * example: filter.setDescription("JBroFuzz Fuzzing Session Files");
	 *
	 * @see setDescription
