...
public class TableSorter extends AbstractTableModel {
	...
	private static final Directive EMPTY_DIRECTIVE = new Directive( -1, TableSorter.NOT_SORTED);
	...
	protected Comparator getComparator(final int column) {
		...
		final Comparator comparator = (Comparator) this.columnComparators.get(columnType);
		if (comparator != null) {
			return comparator;
		}
	...
	/**
	 * <p>Set the value at a particular row and column to the given object.</p>
	 * @param aValue Object
	 * @param row int
	 * @param column int
	 */
	...
	private class Row implements Comparable {
		...
		public int compareTo(final Object o) {
			...
			for (final Iterator it = TableSorter.this.sortingColumns.iterator(); it.hasNext(); ) {
	...
	private class TableModelHandler implements TableModelListener {
		public void tableChanged(final TableModelEvent e) {
			...
			if ((e.getFirstRow() == e.getLastRow()) &&
					...
					(TableSorter.this.getSortingStatus(column) == TableSorter.NOT_SORTED) && (TableSorter.this.modelToView != null)) {
				final int viewIndex = TableSorter.this.getModelToView()[e.getFirstRow()];
				TableSorter.this.fireTableChanged(new TableModelEvent(TableSorter.this, viewIndex,
	...
	private class SortableHeaderRenderer implements TableCellRenderer {
		...
		public Component getTableCellRendererComponent(final JTable table, final Object value,
			...
			final Component c = this.tableCellRenderer.getTableCellRendererComponent(table,
