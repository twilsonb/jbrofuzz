...
public class MainSniffingPanel
  ...
  // The table model
  private MainSniffingTableModel tableModel;
  // The boolean if stop has been pressed
  private boolean stopPressed;
  // The TCP Connection listener
  private TCPConnectionListener reflector;
  /**
   ...
   * @param m MainWindow
   */
  public MainSniffingPanel(MainWindow m) {
    super();
    setLayout(null);
    setBorder(BorderFactory.createCompoundBorder(
        BorderFactory.createTitledBorder(" Sniffing "),
    ...
    // Set the borders
    rHostPanel.setBorder(BorderFactory.createCompoundBorder(
        BorderFactory.createTitledBorder(" Remote Host "),
        BorderFactory.createEmptyBorder(1, 1, 1, 1)));
    rPortPanel.setBorder(BorderFactory.createCompoundBorder(
        BorderFactory.createTitledBorder(" Port "),
        BorderFactory.createEmptyBorder(1, 1, 1, 1)));
    lHostPanel.setBorder(BorderFactory.createCompoundBorder(
        BorderFactory.createTitledBorder(" Local Host "),
        BorderFactory.createEmptyBorder(1, 1, 1, 1)));
    lPortPanel.setBorder(BorderFactory.createCompoundBorder(
        BorderFactory.createTitledBorder(" Port "),
        BorderFactory.createEmptyBorder(1, 1, 1, 1)));
    ...
    tableModel = new MainSniffingTableModel();
    ...
    rowSM.addListSelectionListener(new ListSelectionListener() {
      public void valueChanged(ListSelectionEvent e) {
        ...
        if (lsm.isSelectionEmpty()) {
          ...
          MainSniffingViewer vew = new MainSniffingViewer(getMainWindow().
              getSniffingPanel(), s);
        }
      }
    ...
    stopButton.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        ...
        getMainWindow().getMainMenuBar().setFuzzStartEnabled(true);
